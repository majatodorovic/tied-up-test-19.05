      ...
      <div className="flex flex-col mt-5 md:mt-16 items-center relative">
        <div className="w-[95%] mx-auto lg:w-full lg:px-[3rem]">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6 mt-[2rem]">
            ...
            <Link
              href="https://www.google.com/maps/place/%D0%9A%D0%BD%D0%B5%D0%B7%D0%B0+%D0%9C%D0%B8%D1%85%D0%B0%D0%B8%D0%BB%D0%B0+36,+%D0%91%D0%B5%D0%BE%D0%B3%D1%80%D0%B0%D0%B4+11001/@44.8178824,20.456913,324m/data=!3m1!1e3!4m6!3m5!1s0x475a654ccd30f467:0x35eceafec3590fc9!8m2!3d44.8181332!4d20.4569367!16s%2Fg%2F11bw4jsytk?entry=ttu&g_ep=EgoyMDI1MDQyMS4wIKXMDSoJLDEwMjExNDUzSAFQAw%3D%3D"
              target="_blank"
            >
              <div className="col-span-1">
                <div className="overflow-hidden rounded-[20px]">
